...
const Carousel = () => {
    ...
    return (
        <div className='max-w-[1240px] mx-auto px-4 py-16 relative flex justify-center items-center'>
            <BsArrowLeftSquareFill onClick={prevSlide} className='top-[50%] text-3xl text-white cursor-pointer absolute left-8'/>
            <BsArrowRightSquareFill onClick={nextSlide} className='top-[50%] text-3xl text-white cursor-pointer absolute right-8'/>
